...
_SYSTEM_KB_GROUNDING_RULE = (
    ...
    "last_price: <last price or current price atom value if present — numeric only, e.g. 197.22>\n"
    "price_target: <price target atom value if present — numeric only, e.g. 250.76>\n"
    "upside_pct: <upside percentage atom value if present — numeric only, e.g. 35.45>\n"
    "invalidation_price: <invalidation price atom value if present — numeric only, e.g. 141.09>\n"
