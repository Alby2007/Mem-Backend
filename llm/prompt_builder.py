...
_SYSTEM_GEO_NO_PORTFOLIO_RULE = (
    ...
    "Cover these points in natural flowing text:\n"
    "Lead with what the KB says is happening: quote 2-4 key_finding, headline, or summary atoms "
    "verbatim, naming the source (e.g. gdelt_tension:, ucdp_conflict:, news_wire_defense_news:). "
    "Do NOT paraphrase.\n"
    "Then briefly state the current market context in one sentence: the market_regime atom value "
    "and any relevant macro atoms (central_bank_stance, yield_curve_spread) if present.\n"
    "Then mention what asset classes or tickers the KB has data on that are relevant to the conflict "
    "(e.g. gold, oil, defence ETFs) and their conviction_tier and signal_direction if atoms exist.\n"
    "If the KB has no quantified geo-impact atoms linking this conflict to specific tickers, "
    "say so plainly in one sentence: 'The KB does not currently have a geopolitical_risk_exposure "
